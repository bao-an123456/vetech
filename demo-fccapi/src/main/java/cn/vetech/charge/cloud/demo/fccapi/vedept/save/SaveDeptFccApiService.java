...
@Api(tags = "新增部门信息")
@OpenApiOperation(value = "DEMO_B2G_saveVeDept", title = "新增部门信息",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_saveVeDept"})
public interface SaveDeptFccApiService extends IFccApiInterface<SaveDeptRequest, SaveDeptResponse> {
}