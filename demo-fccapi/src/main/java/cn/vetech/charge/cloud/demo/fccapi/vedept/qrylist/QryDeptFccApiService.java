...
@Api(tags = "查询部门列表")
@OpenApiOperation(value = "DEMO_B2G_qryListVeDept", title = "查询部门列表",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_qryListVeDept"})
public interface QryDeptFccApiService extends IFccApiInterface<QryDeptRequest, QryDeptResponse> {
}