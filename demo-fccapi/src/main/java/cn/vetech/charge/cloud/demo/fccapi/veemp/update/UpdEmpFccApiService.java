...
@Api(tags = "修改员工信息")
@OpenApiOperation(value = "DEMO_B2G_updateVeEmp", title = "修改员工信息",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_updateVeEmp"})
public interface UpdEmpFccApiService extends IFccApiInterface<UpdEmpRequest, UpdEmpResponse> {
