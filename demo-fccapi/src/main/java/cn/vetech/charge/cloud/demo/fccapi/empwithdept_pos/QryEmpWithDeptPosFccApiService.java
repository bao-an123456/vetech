...
@Api(tags = "员工列表带部门/岗位信息查询")
@OpenApiOperation(value = "DEMO_B2G_queryEmpWithDeptPos", title = "员工列表带部门/岗位信息查询",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_queryEmpWithDeptPos"})
public interface QryEmpWithDeptPosFccApiService extends IFccApiInterface<QryEmpWithDeptPosRequest, QryEmpWithDeptPosResponse> {
}