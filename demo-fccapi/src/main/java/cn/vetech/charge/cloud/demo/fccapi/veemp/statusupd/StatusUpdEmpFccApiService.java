...
@Api(tags = "禁用员工信息")
@OpenApiOperation(value = "DEMO_B2G_statusUpdVeEmp", title = "禁用员工信息",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_statusUpdVeEmp"})
public interface StatusUpdEmpFccApiService extends IFccApiInterface<StatusUpdEmpRequest, StatusUpdEmpResponse> {
