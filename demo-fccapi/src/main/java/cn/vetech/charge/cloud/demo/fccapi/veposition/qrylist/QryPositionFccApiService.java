...
@Api(tags = "查询任职列表")
@OpenApiOperation(value = "DEMO_B2G_qryListVePosition", title = "查询任职列表",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_qryListVePosition"})
public interface QryPositionFccApiService extends IFccApiInterface<QryPositionRequest, QryPositionResponse> {
}