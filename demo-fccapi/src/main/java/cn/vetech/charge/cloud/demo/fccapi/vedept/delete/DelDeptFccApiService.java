...
@Api(tags = "删除部门信息")
@OpenApiOperation(value = "DEMO_B2G_deleteVeDept", title = "删除部门信息",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_deleteVeDept"})
public interface DelDeptFccApiService extends IFccApiInterface<DelDeptRequest, DelDeptResponse> {
}