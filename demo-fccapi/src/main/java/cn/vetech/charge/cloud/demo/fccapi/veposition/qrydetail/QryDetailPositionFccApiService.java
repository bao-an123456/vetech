...
@Api(tags = "查询任职详情")
@OpenApiOperation(value = "DEMO_B2G_queryDetailVePosition", title = "查询任职详情",
        platForm = PlatEnum.FCC, cpbhEnum = CpbhEnum.FL0000, ddlxEnum = DdlxEnum.DDLX0000_1)
@RestController
@RequestMapping({"/fccapi/DEMO_B2G_queryDetailVePosition"})
public interface QryDetailPositionFccApiService extends IFccApiInterface<QryDetailPositionRequest, QryDetailPositionResponse> {
}